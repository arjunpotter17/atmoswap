...
import { getAsset } from "@utils/fetchTokenMetadata";
import Spinner from "@components/spinner/spinner";
import { RouteModalProps } from "@/lib/types/routeTypes";
...
export const RouteModal = ({
      ...
      await Promise.all(
        routePlan.map(async (route) => {
          ...
          data[route.swapInfo.outputMint] = {
            ...
            image: routeAsset.content.links.image || "",
          };
        })
      );
  ...
  return (
    <div
      ...
      className="fixed inset-0 flex items-center justify-center z-50 bg-atmos-secondary-teal bg-opacity-10"
    >
