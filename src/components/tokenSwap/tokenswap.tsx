...
import { TransactionInfoBox } from "@components/txInfoBox/txInfoBox";
import { toggleSettingsPanel } from "@/lib/utils/toggleSettingsPanel";
import { handleSwapTokens } from "@/lib/utils/handleSwapTokens";
import { fetchPriceData } from "@/lib/utils/fetchPrice";
import { RoutePlan } from "@/lib/types/routeTypes";
import { TokenInfo } from "@/lib/types/tokenTypes";
import { useSlippage } from "@/lib/contexts/slippage";
...
const TokenSwap = (): JSX.Element => {
  ...
  const debouncedSellToken = useDebounce(sellingToken, 700); //this and below are just so that the price fetch gets proper values 
